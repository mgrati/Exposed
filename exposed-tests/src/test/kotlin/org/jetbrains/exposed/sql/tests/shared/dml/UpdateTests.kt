...
class UpdateTests : DatabaseTestsBase() {
    ...
    fun testUpdateWithJoin01() {
        withCitiesAndUsers(exclude = listOf(TestDB.SQLITE, TestDB.DB2)) { _, users, userData ->
    ...
    fun testUpdateWithJoin02() {
        withCitiesAndUsers(exclude = TestDB.allH2TestDB + TestDB.SQLITE + TestDB.DB2) { cities, users, userData ->
